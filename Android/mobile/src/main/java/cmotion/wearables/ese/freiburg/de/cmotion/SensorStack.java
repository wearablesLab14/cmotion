...
public class SensorStack {
	 ...
	 */
	public SensorStack() {
		sensorDataMap = new HashMap<String, SensorData>();
	}
    ...
    /**
     * Returns true if a sensor with the given device ID is already registered.
     * @param deviceId
     * @return
     */
    public boolean sensorExists(String deviceId) {
        return sensorDataMap.containsKey(deviceId);
    }
