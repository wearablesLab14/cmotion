...
/* Simple implementation for the MPU6050/MPU9150 Sensor
   It does not use interrupts. Extending it to use interrupts should be easy 
   by just changing the isReady() method.
