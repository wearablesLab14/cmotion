...
public class MainActivity extends Activity {
	...
	private Runnable reader = new Runnable() {
		...
		public void run() {
			try {
				...
				android.util.Log.e("TrackingFlow",
						"WWWTTTFFF3wwgftggggwww4243: " + CONTINUE_READ_WRITE);
				int bufferSize = 1024;
				int bytesRead = -1;
	 ...
	 * 
	 * @Override public void run() { int index = 0; while (CONTINUE_READ_WRITE)
	 * { try { os.write("Message From Client" + (index++) + "\n"); os.flush();
